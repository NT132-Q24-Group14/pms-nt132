...
<html lang="en">
  <head>
    ...
    <!-- Menu CSS -->
    <link
      href="${ctx}/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css"
      rel="stylesheet"
    />
    <!-- animation CSS -->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-xs-12">
              <div class="white-box">
                <form method="post" action="${ctx}/user-edit" class="form-horizontal form-material">
                  ...
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <a href="${ctx}/user" class="btn btn-primary"
                        >Quay lại</a
                      >
                    </div>
                  </div>
