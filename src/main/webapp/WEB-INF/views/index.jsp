...
<head>
    ...
    <!-- toast CSS -->
    <link href="${ctx}/plugins/bower_components/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- morris CSS -->
    <link href="${ctx}/plugins/bower_components/morrisjs/morris.css" rel="stylesheet">
    <!-- animation CSS -->
...
<body>
    ...
    <!--Counter js -->
    <script src="${ctx}/plugins/bower_components/waypoints/lib/jquery.waypoints.js"></script>
    <script src="${ctx}/plugins/bower_components/counterup/jquery.counterup.min.js"></script>
    <!--Morris JavaScript -->
    <script src="${ctx}/plugins/bower_components/raphael/raphael-min.js"></script>
    <script src="${ctx}/plugins/bower_components/morrisjs/morris.js"></script>
