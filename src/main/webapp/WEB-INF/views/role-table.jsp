            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="${ctx}/role-add" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                    ...
                                    <tbody>
                                    		<c:forEach items="${roles}" var="item" varStatus="loop">
                                    			<tr>
	                                    			...
	                                    			<td>
	                                    				<c:if test="${user.id == 1 }">
                                                			<a href="${ctx}/role-edit?id=${item.id}" class="btn btn-sm btn-primary">Sửa</a>
										                <a href="${ctx}/role-delete?id=${item.id}" class="btn btn-sm btn-danger"
