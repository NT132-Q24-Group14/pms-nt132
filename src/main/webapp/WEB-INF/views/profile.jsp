            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="${ctx}/plugins/images/large/1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="${ctx}/plugins/images/users/varun.jpg"
                                    		...
                                    		<c:forEach items="${tasks}" var="item">
                                    			<tr>
	                                           	...
	                                           	<td>${item.status_name}</td>
                                    				<td>
                                    					<a href="${ctx}/profile-edit" class="btn btn-sm btn-primary">Cập nhật</a>
                                    				</td>
                                    			</tr>
                                    		</c:forEach>
                                    </tbody>
